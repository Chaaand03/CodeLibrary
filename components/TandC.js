...
const TandC = () => {
  ...
  return (
    <>
      <Head>
        <title>Terms and Conditions - Code.LIBRARY</title>
        <meta
          name="description"
          content="Read our terms and conditions, refund policy, cancellation policy, and privacy policy for Code.LIBRARY online coaching lessons."
        />
        <meta
          name="keywords"
          content="terms and conditions, refund policy, cancellation policy, privacy policy, Code.LIBRARY, online coaching"
        />
