        ...
        <>
            ...
            <div className="bg-gray-100">
                ...
                <section className="bg-white py-16 px-4 md:px-10 text-center">
                    <h2 className="text-2xl font-bold text-purple-900 mb-10">Our Mission</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-6xl mx-auto text-left">
                        {[
                            ...
                            >
                                <h3 className="font-bold text-md text-purple-900 mb-2">{item.title}</h3>
                ...
                <section className="bg-pink-100 py-16 px-4 text-center">
                    <h2 className="text-2xl font-bold text-purple-900 mb-10">Our Impact</h2>
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-5xl mx-auto">
                        {[
                            ...
                            >
                                <h3 className="text-xl font-bold text-purple-900">{item.number}</h3>
                ...
                <section className="bg-white py-16 px-4 text-center">
                    <h2 className="text-2xl font-bold text-purple-900 mb-10">Meet Our Team</h2>
                ...
                {/* Meet Our Tutors */}
                <section className="bg-pink-100 py-16 px-4 text-center">
                    <h2 className="text-2xl font-bold text-purple-900 mb-10">Meet Our Tutors</h2>
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10 max-w-6xl mx-auto">
                        {[
